...
int main(void)
{
    ...
    AIDB_TEST_ASSERT_TRUE(aidb_context_init(NULL) == AIDB_ERROR_INVALID_ARGUMENT);
    ...
    AIDB_TEST_ASSERT_TRUE(aidb_context_set_error(&context, AIDB_ERROR_PARSE, NULL) == AIDB_OK);
    AIDB_TEST_ASSERT_TRUE(strcmp(aidb_context_error_message(&context), "parse error") == 0);
    ...
    AIDB_TEST_ASSERT_TRUE(aidb_context_last_status(NULL) == AIDB_ERROR_INVALID_ARGUMENT);
    AIDB_TEST_ASSERT_TRUE(aidb_context_error_message(NULL) != NULL);
    AIDB_TEST_ASSERT_TRUE(strcmp(aidb_context_error_message(NULL), "null context") == 0);
